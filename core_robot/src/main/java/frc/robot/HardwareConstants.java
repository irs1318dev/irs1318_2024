...
public class HardwareConstants
{
    ...
    public static final double SDSDRIVETRAIN_DRIVE_WHEEL_DIAMETER = 3.93; // SDS Mk4i code claims their 4-inch wheels are actually 3.95 inches now (in inches) We think its 3.95 - main 3.97
