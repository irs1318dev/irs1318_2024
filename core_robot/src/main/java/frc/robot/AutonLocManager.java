...
public class AutonLocManager
{
    ...
    private void setValues()
    {
        ...
        this.P5M = new Point2d(AutonLocManager.getXPosition(this.isRed, 220 + 20), 162);
        ...
        this.P8 = new Point2d(AutonLocManager.getXPosition(this.isRed, 5), 24.0);
        this.P8M = new Point2d(AutonLocManager.getXPosition(this.isRed, 10/*p8 */ + 20), 23.0); 
        this.P9 = new Point2d(AutonLocManager.getXPosition(this.isRed, 5), 95.64);
        this.P9M = new Point2d(AutonLocManager.getXPosition(this.isRed, 10 /*p9 */ + 20), 65.64);
        ...
        this.P11M = new Point2d(AutonLocManager.getXPosition(this.isRed, 0 /*p11 */ + 20), 227.64);
