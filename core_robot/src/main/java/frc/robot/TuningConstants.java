...
public class TuningConstants
{
    ...
    public static final double SDSDRIVETRAIN_STEER_MOTOR1_ABSOLUTE_OFFSET = TuningConstants.COMPETITION_ROBOT ? 0.300048 : 0.17212; // -0.198486 + 0.5; // rotations
    public static final double SDSDRIVETRAIN_STEER_MOTOR2_ABSOLUTE_OFFSET = TuningConstants.COMPETITION_ROBOT ? 0.313232 : 0.15698;//-0.186768 + 0.5; // rotations
    public static final double SDSDRIVETRAIN_STEER_MOTOR3_ABSOLUTE_OFFSET = TuningConstants.COMPETITION_ROBOT ? 0.373046 : -0.28979;//0.46337890625; // rotations
    public static final double SDSDRIVETRAIN_STEER_MOTOR4_ABSOLUTE_OFFSET = TuningConstants.COMPETITION_ROBOT ? -0.15820 : -0.35327;//0.336670 + 0.5; // rotations
    ...
    public static final boolean ARM_USE_STARTUP_DONT_BREAK_ME_MODE = true;

    public static final double ARM_STARTUP_DONT_BREAK_ME_THRESHOLD = 5.0;
    ...
    public static final double[][] ARM_GRAVITY_COMPENSATION_SAMPLES =
        {
            ...
            { 0.054989320337772, 0.05462221133709, 0.054989320337772, 0.054989320337772, 0.054989320337772, 0.084989016056061, 0.089994047880173, 0.094999087154865, 0.094999087154865, 0.090604421794415, 0.0999736014008522}, // shoulder fifth position
            { 0.054989320337772, 0.054989320337772, 0.054989320337772, 0.075894494652748, 0.104978640675545, 0.124978640675545, 0.104978640675545, 0.104978640675545, 0.104978640675545, 0.104978640675545, 0.104978640675545} // shoulder sixth position
        };
