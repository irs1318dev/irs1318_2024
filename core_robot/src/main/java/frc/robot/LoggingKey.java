...
public enum LoggingKey
{
    ...
    ArmShoulderPower("arm/shPow", LoggingType.Number, false, true),
    ArmShoulderFollowerPower("arm/shPow2", LoggingType.Number, false, true),
    ...
    ArmWristPower("arm/wrPow", LoggingType.Number, false, true),
