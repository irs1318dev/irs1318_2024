...
public enum LoggingKey
{
    ...
    DriverActiveMacros("driver.activeMacros", 1, true),
    DriverActiveShifts("driver.activeShifts"),
    AutonomousSelection("auto.selected"),
    AutonomousDSMessage("auto.dsMessage"),
    OffboardVisionAprilTagXOffset("vision.atXOffset", 1),
    OffboardVisionAprilTagYOffset("vision.atYOffset", 1),
    OffboardVisionAprilTagZOffset("vision.atZOffset", 1),
    OffboardVisionAprilTagYaw("vision.atYaw", 1),
    OffboardVisionAprilTagPitch("vision.atPitch", 1),
    OffboardVisionAprilTagRoll("vision.atRoll", 1),
    OffboardVisionAprilTagId("vision.atId", 1),
    OffboardVisionProcessingMode("vision.processingMode", 1),
    OffboardVisionEnableStream("vision.enableStream", 1),
    OffboardVisionDesiredTarget("vision.desiredTarget", 1),
    OffboardVisionMissedHeartbeats("vision.missedHeartbeats", 1),
    ...
    ArmFixedWithIK("arm.fixed_with_IK"), // , 1),
    ArmIntakeTopAbsX("arm.intake_top_abs_x"), // , 1),
    ArmIntakeTopAbsZ("arm.intake_top_abs_z"), // , 1),
    ArmHittingRobot("arm.hit_robot"), // , 1),
    ArmIntakeBottomAbsX("arm.intake_bot_abs_x"), // , 1),
    ArmIntakeBottomAbsZ("arm.intake_bot_abs_z"), // , 1),
    ArmShooterBottomAbsX("arm.shooter_bot_abs_x"), // , 1),
    ArmShooterBottomAbsZ("arm.shooter_bot_abs_z"), // , 1),
    ArmShooterTopAbsX("arm.shooter_top_abs_x"), // , 1),
    ArmShooterTopAbsZ("arm.shooter_top_abs_z"), // , 1),
    ArmWristAbsX("arm.wrist_abs_x"), // , 1),
    ArmWristAbsZ("arm.wrist_abs_z"), // , 1),

    ArmExtensionType("arm.extension_type"), // , 1),
    ArmWristIKDesired("arm.wrist_ik_desired"), //, 1),
    ArmShoulderIKDesired("arm.sh_ik_desired"), // , 1),
    ArmShoulderLastLegal("arm.sh_lst_legal_pos"), // , 1),

    ActWristDesired("arm.sh_nt_tsk_wr_ang"), // , 1),
    ArmTheta4("arm.theta_4"),
